...
void xxxtestone(int n)
{
    ...
    switch (n)
    {
        default: {
            ...
            assert(s.insert(0,ARRAY[4]));
            assert(s.insert(1,ARRAY[2]));
            assert(s.insert(2,ARRAY[4]));
            assert(s.insert(3,ARRAY[2]));
            assert(s.insert(4,ARRAY[2]));
            
        
            assert(s.remove(ARRAY[2]) == 3);
            ...
            // This test checked that Sequences can be properly copied and
            // destroyed.
        } break; case 84: {
            s.insert(0,ARRAY[0]);
            s.insert(1,ARRAY[1]);
            ...
            // This test checked that empty sequences can be assigned and
            // properly destroyed.
        } break; case 89: {
            ...
            // This test checked that self-assignment doesn't change the number
            // of items in existence.
        } break; case 94: {
            // This test checked that self-assignment doesn't change the Sequence.
#endif
        }
    }
}
